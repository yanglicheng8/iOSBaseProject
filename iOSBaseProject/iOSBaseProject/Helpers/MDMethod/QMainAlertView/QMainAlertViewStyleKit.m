...
// ------------------------------------
@implementation QMainAlertViewStyleKit
...
+ (UIImage*)imageOfCheckmark
{
    ...
    [QMainAlertViewStyleKit drawCheckmark];
...
+ (UIImage*)imageOfCross
{
    ...
    UIGraphicsBeginImageContextWithOptions(CGSizeMake(80, 80), NO, 0);
    [QMainAlertViewStyleKit drawCross];
...
+ (UIImage*)imageOfNotice
{
    ...
    UIGraphicsBeginImageContextWithOptions(CGSizeMake(80, 80), NO, 0);
    [QMainAlertViewStyleKit drawNotice];
...
+ (UIImage*)imageOfWarning
{
    ...
    UIGraphicsBeginImageContextWithOptions(CGSizeMake(80, 80), NO, 0);
    [QMainAlertViewStyleKit drawWarning];
...
+ (UIImage*)imageOfInfo
{
    ...
    UIGraphicsBeginImageContextWithOptions(CGSizeMake(80, 80), NO, 0);
    [QMainAlertViewStyleKit drawInfo];
...
+ (UIImage*)imageOfEdit
{
    ...
    UIGraphicsBeginImageContextWithOptions(CGSizeMake(80, 80), NO, 0);
    [QMainAlertViewStyleKit drawEdit];
...
+ (UIImage*)imageOfQuestion
{
    ...
    UIGraphicsBeginImageContextWithOptions(CGSizeMake(80, 80), NO, 0);
    [QMainAlertViewStyleKit drawQuestion];
